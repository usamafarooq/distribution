...
class MY_Controller extends CI_Controller {
    ...
    {
    	$file = $_SERVER['DOCUMENT_ROOT'].'/new_distribution/application/models/'.ucfirst($module_name).'.php';
		if(!is_file($file)){
		    $contents = '<?php
		    ';
    ...
    {
    	$file = $_SERVER['DOCUMENT_ROOT'].'/new_distribution/application/controllers/'.ucfirst($controller_name).'.php';
		if(!is_file($file)){
		    $contents = '<?php
		    ';
    ...
    {
    	$directoryName = $_SERVER['DOCUMENT_ROOT'].'/new_distribution/application/views/'.$url;
    ...
    {
    	$file = $_SERVER['DOCUMENT_ROOT'].'/new_distribution/application/views/'.$controller_name.'/index.php';
		if(!is_file($file)){
    ...
    {
    	$file = $_SERVER['DOCUMENT_ROOT'].'/new_distribution/application/views/'.$controller_name.'/create.php';
		if(!is_file($file)){
    ...
    {
    	$file = $_SERVER['DOCUMENT_ROOT'].'/new_distribution/application/views/'.$controller_name.'/edit.php';
		if(!is_file($file)){
