...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url() ?>distribution/insert" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="password" type="text" value="" id="example-text-input" placeholder="" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="scm_code" type="text" value="" id="example-text-input" placeholder="" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-3 col-form-label">Scm Name<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input class="form-control" name="scm_name" type="text" value="" id="example-text-input" placeholder="" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-3 col-form-label">Dsr Code<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input class="form-control" name="dsr_code" type="text" value="" id="example-text-input" placeholder="" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-3 col-form-label">Dsr Name<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input class="form-control" name="dsr_name" type="text" value="" id="example-text-input" placeholder="" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-3 col-form-label">Station<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input class="form-control" name="station" type="text" value="" id="example-text-input" placeholder="" required="">
                                </div>
                            </div>
