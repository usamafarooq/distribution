...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url() ?>order/update" enctype="multipart/form-data">
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input class="form-control" name="Datename" type="date" value="<?php  echo $orders['Datename'] ?>" id="example-text-input" placeholder="" required="" readonly>
    </div>
</div>
