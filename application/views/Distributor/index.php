                                        ...
                                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $products_detail['scm_order_no']; ?></td>
                                                    <td><?php echo $products_detail['dc_no']; ?></td>
                                                    <td><?php echo $products_detail['dc_type']; ?></td>
                                                    <td><?php echo $products_detail['cn']; ?></td>
                                                    <td><?php echo $products_detail['kg']; ?></td>
                                                    <td><?php echo $products_detail['cartons']; ?></td>
                                                    <td><?php echo $products_detail['packs']; ?></td>
                                                    <!-- <td><?php echo $products_detail['scm_name']; ?></td> -->
                                                    <td><?php echo date('d M Y', strtotime($products_detail['date'])); ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>distributor/view/<?php echo $products_detail['id']; ?>"><img src="<?php echo base_url() ?>assets/record1.png" title="View Order" alt="View Order" width="35" height="35"></a>
                                                        <a href="<?php echo base_url(); ?>distributor/all/<?php echo $products_detail['id']; ?>"><button type="button" class="btn btn-info">Received</button></a>
