        ...
        <div class="content-header">
            ...
            <div class="header-title">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Haider</li>
                </ol>
            </div>
        </div>
        <!-- /. Content Header (Page header) -->

        <form method="post" action="<?php echo base_url() ?>haider/insert" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body"><div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="phone" type="number" value="" id="example-text-input" placeholder="" >
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="date_of_birth" type="date" value="" id="example-text-input" placeholder="" >
                                </div>
